...
A comprehensive collection of ready-to-use badges for your GitHub profile!
...
![Foundation](https://img.shields.io/badge/Foundation-0093D0?style=for-the-badge&logo=foundation&logoColor=white)
```
...
![Tornado](https://img.shields.io/badge/Tornado-0E4C92?style=for-the-badge&logo=tornado&logoColor=white)
```
...
![Thunder Client](https://img.shields.io/badge/Thunder_Client-6E3FBB?style=for-the-badge&logo=thunder&logoColor=white)
```
...
![Turbopack](https://img.shields.io/badge/Turbopack-0C0E12?style=for-the-badge&logo=turbopack&logoColor=white)
...
![LightGBM](https://img.shields.io/badge/LightGBM-02B3E4?style=for-the-badge&logo=lightgbm&logoColor=white)
```
...
[![Website](https://img.shields.io/badge/Website-4285F4?style=for-the-badge&logo=google-chrome&logoColor=white)](https://YOUR_WEBSITE)
...
[![Open Collective](https://img.shields.io/badge/Open_Collective-7FADF2?style=for-the-badge&logo=open-collective&logoColor=white)](https://opencollective.com/YOUR_PROJECT)
```
...
![Stars](https://img.shields.io/github/stars/YOUR_USERNAME?style=for-the-badge&logo=github)
```
...
You can customize badge colors by modifying the hex color code in the URL:

```markdown
![Custom Badge](https://img.shields.io/badge/Custom-Badge-YOUR_COLOR?style=for-the-badge&logo=LOGO_NAME&logoColor=white)
```

**Example:**
```markdown
![Custom React](https://img.shields.io/badge/React-FF1493?style=for-the-badge&logo=react&logoColor=white)
```
...
?style=for-the-badge   # For-the-badge style (recommended)
...
3. Use the slug (lowercase name with hyphens)

**Example:** "Visual Studio Code" → `visual-studio-code`

### Custom Badges

Create completely custom badges:

```markdown
![Custom](https://img.shields.io/badge/LEFT_TEXT-RIGHT_TEXT-COLOR?style=for-the-badge)
```

**Example:**
```markdown
![Streak](https://img.shields.io/badge/100_Days-Coding_Streak-00ADD8?style=for-the-badge)
```
...
```markdown
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/YOUR_USERNAME/REPO?style=for-the-badge)
![GitHub last commit](https://img.shields.io/github/last-commit/YOUR_USERNAME/REPO?style=for-the-badge)
![GitHub repo size](https://img.shields.io/github/repo-size/YOUR_USERNAME/REPO?style=for-the-badge)
![GitHub issues](https://img.shields.io/github/issues/YOUR_USERNAME/REPO?style=for-the-badge)
![GitHub pull requests](https://img.shields.io/github/issues-pr/YOUR_USERNAME/REPO?style=for-the-badge)
```
...
Or vertically with line breaks:
...
1. **Organization:** Group related badges together (languages, frontend, backend, etc.)
2. **Consistency:** Use the same style across all badges (`for-the-badge` recommended)
3. **Relevance:** Only include technologies you actively use
4. **Color Harmony:** Choose colors that work well together
5. **Mobile:** Test how badges appear on mobile devices
6. **Performance:** Don't overload with too many badges (15-30 is ideal)
7. **Updates:** Regularly review and update badges as you learn new technologies
8. **Custom Logos:** Upload custom logos to create unique badges
9. **Alt Text:** Always provide meaningful alt text for accessibility
...
_Found this helpful? Give it a ⭐ and share with others!_
